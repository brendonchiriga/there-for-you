...
export default class Login extends Component {
  ...
  onLogin = () => {
    var email = this.state.loginemail.trim();
    var password = this.state.loginpassword.trim();
    if (email == '' || password == '') {
      ...
      try {
          ...
          .then(snapshot => {
            if (snapshot.exists()) {
              ...
              if (set.password == password) {
                AsyncStorage.setItem('tfy_user', JSON.stringify(set));
                ...
                ToastAndroid.showWithGravityAndOffset(
                  'Incorrect Password. Please enter a correct password and try again',
                  ToastAndroid.SHORT,
                  ToastAndroid.CENTER,
                  5,
                  25,
              ...
              ToastAndroid.showWithGravityAndOffset(
                'Seems like this user does not exist. Please register a new account',
                ToastAndroid.SHORT,
                ToastAndroid.CENTER,
                5,
                25,
        ...
        ToastAndroid.showWithGravityAndOffset(
          'Login Failed. There was an error fetching the user from the database',
          ToastAndroid.SHORT,
          ToastAndroid.CENTER,
          5,
          25,
      ...
      <Container
        ...
        <View style={styles.inputView}>
          ...
          <TextInput
            ...
            onEndEditing={() => this.passwordfield.focus()}
    ...
    return (
      <Container
        ...
        <Image
          ...
          source={require('./assets/tfy_logo.jpg')}
        />
        ...
        <KeyboardAvoidingView style={{flex: 1}} behavior="height">
          <Tabs
            ...
            swipeEnabled
            initialPage={1}
            renderTabBar={this.onRenderTabBar}
            ...
            <Tab
              ...
              <Content>{this.onRenderLogin()}</Content>
            </Tab>
            <Tab
              heading="Sign Up"
              props
              ...
              <Content>{this.onRenderSignUp()}</Content>
            </Tab>
          </Tabs>
        </KeyboardAvoidingView>
      </Container>
